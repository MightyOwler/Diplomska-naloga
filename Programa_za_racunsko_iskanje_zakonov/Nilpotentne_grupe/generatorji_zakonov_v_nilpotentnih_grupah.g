...
filePath := "C:/Users/jasak/Documents/Jasa/Sola/FMF/3_letnik/Diploma/Programa_za_iskanje_zakonov/Nilpotentne_grupe/generatorji_zakonov_v_nilpotentnih_grupah.g";
...
for result in results do
    AppendTo(outputFile, Concatenation("Struktura nilpotentne grupe G: << ", StructureDescription(result.group), " >>\n");
