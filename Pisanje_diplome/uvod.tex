\section{Uvod}
Začnimo z intuitivno definicijo zakona v grupi, ki jo bomo v nadaljevanju natančneje formulirali s pomočjo prostih grup.
...
ghg^{-1}h^{-1} = [g,h] = 1_G.
\end{equation*}
Grupa $G$ je torej Abelova natanko tedaj, ko je beseda $aba^{-1}b^{-1}$ v njej zakon. 
...
asimptotsko rast dolžine najkrajših netrivialnih zakonov v družinah grup, recimo za družino $\text{Sym}(n)$? Kaj pa za vse grupe moči $n$ ali manj? 
...
kako se lahko z uporabo računalnika lotimo preučevanja zakonov.
...
ki matematikom burijo domišljijo že od začetka 20.~stoletja. Ti problemi sprašujejo po končnosti specifičnih kvocientov prostih grup, kar bo podrobneje razloženo v razdelku \ref{sec_racunalnisko_iskanje}.
