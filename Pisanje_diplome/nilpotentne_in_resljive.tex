...
Zdaj moramo pridobljeno znanje le še prevesti na nilpotentne grupe. Pred tem moramo dokazati, da za vsako celo število $n \ge 0$ velja $G^{(n)} \subseteq \gamma_{2^{n}}(G)$. Ideja za dokaz te trditve je povzeta po \cite{Schneider_2016}.

\begin{lema}
\label{lem_tri_podgrupe}
Naj bo $G$ grupa, $A, B, C \trianglelefteq G$ njene edinke in $D \le G$ njena podgrupa. Če velja \begin{equation*}
