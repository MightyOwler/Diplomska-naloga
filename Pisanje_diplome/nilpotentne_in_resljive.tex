...
Zdaj moramo pridobljeno znanje le še prevesti na nilpotentne grupe. Pred tem moramo dokazati, da za vsako celo število $n \ge 0$ velja $G^{(n)} \subseteq \gamma_{2^{n}}(G)$. Ideji za dokaza se nahajata v \cite[str.~17--18]{Schneider_2016}.
